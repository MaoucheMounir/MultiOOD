...
from mounirood.modality_fusion import calc_perturbations, ponderation_predictor, normalization_predictor
...
# scores_id = ponderation_predictor(tau)(confs_modalites_id, perturbations_id)
# scores_ood = ponderation_predictor(tau)(confs_modalites_ood, perturbations_ood)
scores_id = normalization_predictor(confs_modalites_id, perturbations_id)
scores_ood = normalization_predictor(confs_modalites_ood, perturbations_ood)
