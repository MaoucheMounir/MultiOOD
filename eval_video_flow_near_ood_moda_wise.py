...
for dataset in ood_datasets:
    ...
    # Fuse the modalities
    ID_ACC = aggregate(id_accs, args.aggregation)
    
    
    ood_conf = aggregate(np.vstack(confs), args.aggregation)
    ...
    save_results_gen(backbone="baseline", method=args.aggregation,
                    ...
                    id_acc=ID_ACC, exec_time="N/A", filename_prefix="aggregation_near_", appen=args.appen)